...
INSERT INTO `users` (`id`, `fname`, `mname`, `lname`, `address`, `phone`, `state`, `email`, `password`) VALUES
(1, 'Bishop', 'John', 'Doe', '6 Warri Street Umuahia', '078978798', 'Abia', 'bishop@gmail.com', '1234');
